...
(function($){$.fn.dnngomegamenu=function(m){m=$.extend({slide_speed:200,delay_show:150,delay_disappear:500,megamenuwidth:"box",WidthBoxClassName:".dnn_layout",popUp:"vertical",direction:"ltr"},m||{});var rtl=m.direction=="rtl"?true:false;return this.each(function(index){var me=$(this),primary=me.find(".primary_structure > li"),slide=".dnngo_menuslide",subs=".dnngo_submenu",subbox="dnngo_boxslide",hover="menu_hover",slidedefault="dnngo_slide_menu",interval,interval2;if(rtl){me.addClass("rtl")}
...
$(this).siblings().removeClass(hover);$(this).siblings().find(subs).fadeOut(m.slide_speed);})});};})(jQuery);
